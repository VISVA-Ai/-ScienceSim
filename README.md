...
* **CSS3** - Custom properties, flexbox/grid, animations, and modern glassmorphism.
...
3. **Run a local server:**
   You can use tools like Live Server in VS Code, or Python:
   ```bash
...
---
<div align="center">
  <i>Built for the next generation of scientists.</i>
</div>
